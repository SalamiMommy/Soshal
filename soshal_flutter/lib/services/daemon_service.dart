...
///
/// This service interfaces with native Android code to extract and manage
/// daemon binaries bundled in the APK assets.
class DaemonService {
  static const MethodChannel _channel =
      MethodChannel('com.example.soshal/daemons');
  ...
  static Future<Map<String, bool>> getDaemonStatus() async {
    try {
      final result = await _channel.invokeMethod('getDaemonStatus');
      if (result is Map) {
  ...
  /// Stops the spawned i2pd process.
