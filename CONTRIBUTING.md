...
- **Pure Rust** — All application logic in Rust across 27 core crates; zero TypeScript.
...
4. **Pre-commit hook** runs: `cargo fmt --check`
...
cargo test --workspace    # Run native test suite (~580 tests)
