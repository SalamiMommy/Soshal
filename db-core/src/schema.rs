...
use migrations::{
    v10_perf_indexes, v1_create_tables, v2_create_group_messages, v3_create_social_tables,
    v4_create_sync_tables, v5_create_missing_tables, v6_purge_orphan_fts_rows,
    v7_rebuild_fts_triggers, v8_shared_keys_escrow_confirms, v9_users_fts,
};
...
pub fn migrate(conn: &Connection) -> Result<(), crate::error::DbError> {
    ...
    let steps: &[(i64, StepFn)] = &[
        ...
        (9, |c| v9_users_fts(c).map_err(Into::into)),
